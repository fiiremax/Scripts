...
local OrionLib = {
	OrionColor = Color3.fromRGB(31, 20, 37),
...
local BlacklistedKeys = {Enum.KeyCode.Unknown,Enum.KeyCode.W,Enum.KeyCode.A,Enum.KeyCode.S,Enum.KeyCode.D,Enum.KeyCode.Up,Enum.KeyCode.Left,Enum.KeyCode.Down,Enum.KeyCode.Right,Enum.KeyCode.Slash,Enum.KeyCode.Tab,Enum.KeyCode.Backspace,Enum.KeyCode.Escape,Enum.KeyCode.Space}
...
function OrionLib:MakeWindow(WindowConfig)
	...
	local WindowName = AddThemeObject(SetProps(MakeElement("Label", WindowConfig.Name, 14), {
		Size = UDim2.new(1, -(WindowConfig.ShowIcon and 155 or 130), 2, 0),
	...
	local function updminframe()
		...
		local nwdth = math.clamp(gnw() + 150, 0, 1100)
	...
	MinimizeBtn.MouseButton1Click:Connect(function()
		...
		if minimized then
			...
			WindowName.Size = UDim2.new(1, -(WindowConfig.ShowIcon and 155 or 130), 2, 0)
	...
	function Functions:ChangeIcon(IconId)
		...
		if WindowIcon then
			...
			WindowName.Position = UDim2.new(0, 50, 0, -24)
			WindowName.Size = UDim2.new(1, -155, 2, 0)
		...
		local function Getelmnts(ItemParent, _tabName)
			...
			function ElementFunction:AddDropdown(DropdownConfig)
				...
				function Dropdown:UpdVis()
					...
					local newPos = UDim2.new(0, 0, 0, 32 + totSrchH)
					local newSz = UDim2.new(1, 0, 1, -(32 + totSrchH))
